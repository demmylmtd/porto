export const siteConfig = {
  ...
  socials: {
    ...
    linkedinNewsletter: 'https://www.linkedin.com/build-relation/newsletter-follow?entityUrn=7449281784950972416',
    spotifyPodcast: 'https://open.spotify.com/show/5XCFxYGW8MR4FTX3dNPp0L?si=JaRu7xJ7SXOKm1PPPhTSMA',
    github: 'https://github.com/demmy',
    youtube: 'https://youtube.com/@DemmyFi',
    kumparan: 'https://kumparan.com/muhammad-demmy',
    tiktok: 'https://www.tiktok.com/@demmylmtd',
    instagram: 'https://www.instagram.com/demmylmtd/',
  },
}
...
export const certifications = [
  ...
  },
  {
    ...
    year: '2024',
    category: 'Finance',
    description: 'This certificate confirms completion of Yale’s Financial Markets program covering core market concepts and risk topics.',
    fileName: 'Coursera I0GNYN7YD41B.pdf',
  },
  {
    ...
    fileName: 'citi bank sertifikat.pdf',
  },
  {
  ...
  },
  {
    ...
    fileName: 'Fundamental Financial.pdf',
  },
  {
  ...
  },
  {
    ...
    fileName: 'sertifikasi halal.pdf',
  },
  {
    ...
    fileName: 'sertifikasi ekosistem ekomomi dan keuangan syariah (1).pdf',
  },
  {
  ...
  },
  {
    ...
    fileName: 'CV Muhammad Demmy.pdf',
  },
]
...
export const projects = [
  {
    ...
    description:
      'Finance & economics education channel covering macro explainers, market news, and strong opinion pieces targeting Indonesian audiences.',
  ...
  },
  {
    ...
    description:
      'SMC-based scalping bot for gold (XAUUSD) built in cTrader C# and MetaTrader 5 MQL5. Targets Asian session liquidity sweeps with automated BSL/SSL detection.',
  ...
  },
  {
    ...
    description:
      'This site — built with Next.js 15, TypeScript, and Tailwind CSS. Deployed on Vercel.',
  ...
  },
  {
    ...
    description:
      'Performance analytics dashboard built in Excel for 64 XAUUSD trades. Includes equity curve, win rate, RR ratio, and pivot chart breakdowns.',
...
export const blogPosts = [
  {
    ...
    excerpt:
      'Framing ulang pertanyaan tentang nilai ekonomi pendidikan LIPIA dari perspektif yang lebih tepat.',
    date: '2025',
  ...
  },
  {
    ...
    excerpt:
      'Analisis bagaimana momen Lebaran mempengaruhi konsumsi rumah tangga dan pertumbuhan PDB kuartal pertama.',
    date: '2026',
    link: 'https://kumparan.com/muhammad-demmy',
